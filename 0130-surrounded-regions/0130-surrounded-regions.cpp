...
public:
    ...
    void bfs(vector<vector<char>> &board,vector<vector<int>> &vis, int row, int col, int n, int m){
        ...
        while(!q.empty()){
            ...
            for(int i=0; i<4; i++){
                ...
                if(isValid(newRow, newCol, n, m) && board[newRow][newCol] == 'O' && vis[newRow][newCol] == 0){
                    vis[newRow][newCol] = 1;
